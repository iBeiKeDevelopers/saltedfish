    ...
    <body>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5" style="line-height:36px;margin-bottom:20px;">
                        <div class="col-sm-5"><div class="row">
                            <div class="col-xs-6 neckrow ct"><a href="localhost:8080/index.php?category=实体商品&level=1" style="color:#FD9860;">实体商品</a></div>
                            <div class="col-xs-6 neckrow ct bd-rt"><a href="localhost:8080/index.php?category=非实体商品&level=1" style="color:#FD9860;">非实体商品</a></div>
                        </div></div>
                        <div class="col-sm-7">
                            <div class="col-xs-4 neckrow ct"><a href="localhost:8080/index.php?category=电子产品&level=2">电子产品</a></div>
                            <div class="col-xs-4 neckrow ct"><a href="localhost:8080/index.php?category=生活用品&level=2">生活用品</a></div>
        ...
        <div>
            <script type="text/x-template" id="search-goods">
                <form action="localhost:8080/index.php" method="get" class="search-tips">
                ...
                <div class="rt-float" data-spy="affix" data-offset-top="95" style="width:156px;">
                    ...
                    <div v-if="islogin">
                        ...
                        <div style="text-align:center;">
                            <a href="localhost:8080/users/orders.php" role="button" class="btn btn-success" style="margin-top:5px;width:100%">全部订单</a>
                            <a href="localhost:8080/users/edit-profile.php" role="button" class="btn btn-warning" style="margin-top:5px;width:100%;">编辑名片</a>
                            <a href="localhost:8080/goods/upload.php" role="button" class="btn btn-danger" style="margin-top:5px;width:100%;">上传商品</a>
                        </div>
                    </div>
                        ...
                        <div class="row" style="width:186px;">
                            <div style="min-height:300px;overflow:hidden;border:1px solid #cccccc;border-radius:4px;">
                                ...
                                <div class="col-xs-12" style="text-align:center;padding:15px;">
                                    <a href="localhost:8080/login/login.php" role="button" class="btn btn-warning" style="margin-bottom:10px;">快速登陆</a><br>
                                    <a href="localhost:8080/signin/signin.php" role="button" class="btn btn-default">免费注册</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            $(document).ready(function(){
                ...
                var Goods = {
                    ...
                    computed:{
                        ...
                        jump:function(){
                            return "localhost:8080/goods/show.php?goods_id="+this.go.goods_id;
                        },
                    },
                };
                    ...
                    methods:{
                        jump:function(page){
                            if (this.target.type=="search") {
                                return "localhost:8080/index.php?search="+this.target.search+"&page="+page;
                            }else{
                                return "localhost:8080/index.php?category="+this.target.category+"&level="+this.target.level+"&page="+page;
                            }
                        }
                    },
                };
                ...
                var Gallery = {
                    ...
                    methods:{
                        ...
                        jump:function(id){
                            console.log("localhost:8080/goods/show.php?goods_id="+id);
                            return "localhost:8080/goods/show.php?goods_id="+id;
                        },
                    },
                };
                ...
                var SearchGoods = {
                    ...
                    methods:{
                        search:function(){
                            // var val = this.value;
                            // $.get("localhost:8080/main/api-search.php",{val:val},function(data){
                            //     console.log(data);
                            //     data = data.split("+");
                            //     data.splice(0,1);
                            //     availableTags = data;
                ...
                var ListOrders = {
                    ...
                    methods:{
                        ...
                        jump:function(id,type){
                            ...
                            switch (type) {
                                case 'goods':
                                    url = 'localhost:8080/goods/show.php?goods_id='+id;
                                    break;
                                case 'user':
                                    url = 'localhost:8080/users/users.php?user_id='+id;
                                    break;
                                default:
                                    break;
                            }
